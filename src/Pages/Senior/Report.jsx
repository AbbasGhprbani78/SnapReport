  ...
  const getlineChart = async () => {
    ...
    try {
      const response = await axios.get(
        `${IP}/form/loc-label-count/${valueBarChart}`,
        {
          headers,
        }
      );
      ...
      {showHistory ? (
        ...
        <>
          <div className="reportContainer">
            ...
            <div className="notification-header my-4">Ai Reports History</div>
                    ...
                    {notifs
                      ...
                      .map((notif) => (
                        <Accordion.Item
                          ...
                          key={notif.id}
                          className="mb-3"
                          onClick={() => notifReadHandler(notif.id)}
                        >
                          <Accordion.Header>
                            <div className=" position-relative header-title-notif">
                              ...
                              >
                                ...
                                >
                                  Prediction Of An Accident :{" "}
                                </p>{" "}
                                {notif.status}
                              </p>
                              <p className="date-notif-item ">
